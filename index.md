...
You can download the raw log files of the planners and the per-instances scores for the [TO Track](https://github.com/ipc2023-htn/ipc2023-htn.github.io/raw/main/ipc2023-to-raw-data.zip) and the [PO Track](https://ipc2023-htn.github.io/ipc2023-po-raw-data.zip).
